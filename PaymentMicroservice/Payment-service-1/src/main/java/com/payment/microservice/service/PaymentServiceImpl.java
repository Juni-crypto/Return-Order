...
public class PaymentServiceImpl implements PaymentService{
    ...
    @Override
  	public PaymentDTO reversePaymentService(String RequestId,Integer cardNumber,Integer processingCharge) throws InvalidFormatException{
  		log.info("Payment service started");
  		
  			try {
  				paymentDetails.setCardNumber(cardNumber);
  				paymentDetails.setRequestId(RequestId);
  				paymentDetails.setCreditLimit(paymentDetails.getCreditLimit()+processingCharge);
  				paymentDetails.setProcessingCharge(processingCharge);
