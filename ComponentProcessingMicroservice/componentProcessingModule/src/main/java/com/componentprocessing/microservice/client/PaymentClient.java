...
public interface PaymentClient {
	...
	@PostMapping("/reversepayment/{requestId}/{cardNumber}/{processingCharge}")
	PackagingAndDeliveryDTO reversePaymentDetails( @PathVariable String requestId,@PathVariable int cardNumber,
			@PathVariable int processingCharge,@RequestHeader(name = "Authorization", required = true) String token);
}
